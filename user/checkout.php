...
.checkout-table th, .checkout-table td { padding:10px; border:1px solid #eee; }
...
<div class="main-content">
    <div class="page-content">
      ...
      <form method="post" action="process-sale.php">
        ...
        <table class="checkout-table">
          ...
          <tbody>
            ...
            ?>
              ...
              <input type="hidden" name="items[<?php echo (int)$id; ?>][product_id]" value="<?php echo (int)$id; ?>">
              <input type="hidden" name="items[<?php echo (int)$id; ?>][qty]" value="<?php echo (int)$it['requested_qty']; ?>">
              <input type="hidden" name="items[<?php echo (int)$id; ?>][price]" value="<?php echo htmlspecialchars($it['price']); ?>">
            <?php endforeach; ?>
          </tbody>
          <tfoot>
            <tr>
        ...
        <!-- ✅ New mini form to return selections to add-sales.php -->
        <form method="post" action="add-sales.php" style="display: inline;">
            <?php foreach ($items as $id => $it): ?>
                ...
                <input type="hidden" name="qty[<?php echo (int)$id; ?>]" value="<?php echo (int)$it['requested_qty']; ?>">
            <?php endforeach; ?>
            <button type="submit" class="btn btn-secondary">Modify Selection</button>
        </form>
