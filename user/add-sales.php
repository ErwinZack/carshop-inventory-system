                ...
                <tbody>
                    ...
                    ?>
                        <tr class="<?php echo ($row['quantity'] <= 10) ? 'low-stock-row' : ''; ?>">
                            <td>
                                <input type="checkbox" name="selected[]" value="<?php echo (int)$row['id']; ?>" <?= $isChecked; ?>>
                            </td>
                            ...
                            <td>
                                <input type="number" min="1" name="qty[<?php echo (int)$row['id']; ?>]" class="qty-input" value="<?php echo $quantityValue; ?>">
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
