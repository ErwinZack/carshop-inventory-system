    ...
    <div class="verify-wrapper">
        <div class="verify-container">
            <div class="verify-header">
                ...
                <p class="verify-subtitle">Enter the OTP sent to your email to reset your password.</p>
            </div>
            ...
            <div class="verify-footer">
                <a href="forgot-password.php" class="verify-back">Back to Forgot Password</a>
            </div>
        </div>
    </div>
</body>
