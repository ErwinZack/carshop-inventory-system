...
$lowStock = $conn->query("SELECT COUNT(*) as count FROM products WHERE quantity < 5")->fetch_assoc()['count'];
...
$lowStockQuery = $conn->query("SELECT name, quantity FROM products WHERE quantity < 5");
$productNames = [];
$quantities = [];
