...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'CarShop Auto Care - Admin Password Reset OTP';
        $mail->Body = "
        ...
        $mail->send();
        header("Location: verify-otp-admin.php"); // Admin OTP verification page
        exit();
    } catch (Exception $e) {
    ...
    <div class="forgot-wrapper">
        <div class="forgot-container">
            <div class="forgot-header">
                ...
                <p class="forgot-subtitle">Enter your admin email address and we'll send you an OTP to reset your
                    password.</p>
            </div>
            <form method="POST" class="forgot-form">
                <div class="input-group">
                    <input type="email" name="email" class="forgot-input" placeholder="Admin Email" required>
                </div>
